	...
	$content = '		<h3 class="wpsp-card-title">' . $title . '</h3>
                    ...
                    <div class="box-footer">
                        <div class="wpsp-form-group">
                            ...
                            <a  class="wpsp-btn wpsp-dark-btn" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">Cancel </a>
                        </div>
                        </div>
                    </form>
                </div>
	...
	else
	{
		...
		<div class="wpsp-row">
					<div class="wpsp-col-xs-12">
						...
						<div class="wpsp-panel-heading">
							<h3 class="wpsp-panel-title">Add Transportation</h3>                
						</div>  
							<div class="wpsp-card-body">
							<div class="wpsp-row">
										<div class="wpsp-col-md-12">
											<div class="wpsp-form-group">
												<label class="wpsp-label" for="Name">Vehicle Name <span class="wpsp-required">*</span></label>
												<input type="hidden"  id="wpsp_locationginal" value='.admin_url().'"/>
												<input type="text" class="wpsp-form-control" ID="VhName" name="VhName" placeholder="Vehicle Name">
											</div>
										</div>
										<div class="wpsp-col-md-6">
											<div class="wpsp-form-group">
												<label class="wpsp-label" for="VhNumber">Vehicle Number <span class="wpsp-required"> *</span></label>
												<input type="text" class="wpsp-form-control select_date" ID="VhNumb" name="VhNumb" placeholder="Bus No">
											</div>
										</div>
										<div class="wpsp-col-md-6">
											<div class="wpsp-form-group">
												<label class="wpsp-label" for="Name">Driver Name </label>
												<input type="text" class="wpsp-form-control" ID="DrName" name="DrName" placeholder="Driver Name">
											</div>
										</div>
										<div class="wpsp-col-md-6">
											<div class="wpsp-form-group">
												<label class="wpsp-label" for="Name">Driver Phone </label>
												<input type="text" class="wpsp-form-control" ID="DrPhone" name="DrPhone" placeholder="Driver Phone">
											</div>
										</div>
										<div class="wpsp-col-md-6">
											<div class="wpsp-form-group">
												<label class="wpsp-label" for="Name">Route Fees</label>
												<input type="text" class="wpsp-form-control" ID="route_fees" name="route_fees" placeholder="Route Fees">
											</div>
										</div>
										<div class="wpsp-col-md-12">
											<div class="wpsp-form-group">
												<label class="wpsp-label" for="Name">Vehicle Route </label>
										...
										<div class="wpsp-col-md-12">
												...
												<a href="#" class="wpsp-btn wpsp-dark-btn">Cancel</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="wpsp-row">
						...
						<div class="wpsp-card">                    
							...
							<div class="wpsp-row">
										...
										<div class="wpsp-col-md-6">
											<div class="wpsp-form-group">
												<label for="VhNumber">Vehicle Number </label><span class="wpsp-text-red">*</span>
												<input type="text" class="wpsp-form-control select_date" value="' . $get_trans->bus_no . '" name="VhNumb" placeholder="Bus No">
											</div>
										</div>
										<div class="wpsp-col-md-6">
											<div class="wpsp-form-group">
												<label for="Name">Driver Name </label><span class="wpsp-text-red">*</span>
												<input type="text" class="wpsp-form-control" value="' . $get_trans->driver_name . '" name="DrName" placeholder="Driver Name">
											</div>
										</div>
										<div class="wpsp-col-md-6">
											<div class="wpsp-form-group">
												<label for="Name">Driver Phone </label><span class="wpsp-text-red">*</span>
												<input type="text" class="wpsp-form-control" value="' . $get_trans->phone_no . '" name="DrPhone" placeholder="Driver Phone">
											</div>
										</div>
										<div class="wpsp-col-md-6">
											<div class="wpsp-form-group">
												<label for="Name">Route Fees</label>
												<input type="text" class="wpsp-form-control" ID="route_fees" name="route_fees" placeholder="Route Fees" value="' . $get_trans->route_fees . '">
											</div>
										</div>
										<div class="wpsp-col-md-12">
											<div class="wpsp-form-group">
												<label for="Name">Vehicle Route </label><span class="wpsp-text-red">*</span>
		...
		<div class="wpsp-panel-body">				
			<div class="wpsp-userDetails">
				<table class="wpsp-table">
					...
					<tr>
						<td colspan="2"><strong>Vehicle Route: </strong> ' . $get_trans->bus_route . '</td>	
					</tr>
					</tbody>
				</table>						
			</div>											
						 ...
						 <div class="box-header">
						  ...
						  <form name="AttendanceEntryForm" id="AttendanceEntryForm" method="post" class="form-horizontal">
							...
							<div class="box-footer">
								...
								<button id="AttendanceSubmit" class="wpsp-btn wpsp-btn-success">Submit</button>
									<input type="hidden" value="' . $entry_date . '" name="AttendanceDate">									
									<a href="#" class="wpsp-btn wpsp-btn-danger" data-id="' . $entry_date . '" class="deleteAttendance">Delete </a>
								</div>
								</div>
								</div>
