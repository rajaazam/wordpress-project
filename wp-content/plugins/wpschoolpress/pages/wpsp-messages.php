	...
	if( is_user_logged_in() ) {
		...
		if($current_user_role=='administrator' || $current_user_role=='teacher' || $current_user_role=='parent' || $current_user_role='student') {
            ...
            <section class="content-header">
                <h1>Messages</h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo wpsp_admin_url();?>sch-dashboard"><i class="fa fa-dashboard"></i>
                            Dashboard</a></li>
                    <li><a href="<?php echo wpsp_admin_url();?>sch-messages">Messages</a></li>
                </ol>
            </section>
								...
								<div class="mailbox-header">
									<div class="col-md-2">
										...
										<ul class="list-unstyled mailbox-nav">
											<li class="active">
											<a href="<?php echo wpsp_admin_url();?>sch-messages&tab=inbox"><i class="fa fa-inbox"></i> Inbox<span class="badge badge-success pull-right btn-primary"><?php echo wpsp_UnreadCount(); ?></span></a></li>
											<li><a href="<?php echo  wpsp_admin_url();?>sch-messages&tab=sentbox"><i class="fa fa-sign-out"></i>Sent</a></li>                                
											<li><a href="<?php echo wpsp_admin_url();?>sch-messages&tab=trash"><i class="fa fa-trash"></i>Trash</a></li>                                
										</ul>
												...
												foreach( $msg_block as $msgb ) {
													...
													if( $display ) { ?> 
														...
														<tr class="<?php echo $mstat; ?>">
															...
															<td class="small-col">
																<a class="pointer text-blue viewMess" title="view" href="<?php echo wpsp_admin_url(); ?>sch-messages&mid=<?php echo intval($msgb->mid);?>"><i class="fa fa-eye btn btn-success"></i></a>
