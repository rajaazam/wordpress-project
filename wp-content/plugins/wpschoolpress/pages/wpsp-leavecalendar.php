            ...
            if ($current_user_role == 'administrator' || $current_user_role == 'teacher') {
                ...
                <div class="wpsp-card">
                    <div class="wpsp-card-head">
                        <h3 class="wpsp-card-title">Generate Leave days for a class</h3>                        
                    </div>
                        ...
                        <div class="wpsp-col-md-6">
                            <form action="" name="leaveDaysForm" id="leaveDaysForm" method="post">
                                <div class="wpsp-form-group">
                                    <label class="wpsp-label">Class <span class="wpsp-required">*</span></label>
                                ...
                                <div class="wpsp-form-group">
                                    <label class="wpsp-label">Weekly off <span class="wpsp-required">*</span></label>
                ...
                $class_table=$wpdb->prefix."wpsp_class";
                $leave_table=$wpdb->prefix."wpsp_leavedays";
              //  echo "select cid,c_name,c_sdate,c_edate from $class_table where cid = $examinfo->class_id";
          ...
          <div class="wpsp-popBody"> 
            <div class="wpsp-popInner">                
                ...
                <div class="wpsp-col-md-12">
                    <button type="button" class="wpsp-btn wpsp-dark-btn wpsp-popup-cancel" data-dismiss="modal">Cancel</button>      
                </div>                  
            </div>
            </div> 
          </div>
