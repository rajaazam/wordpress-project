							...
							<tr id="<?php echo intval($wpsp_subject->id);?>" class="pointer">
								...
								<td >
									<div class="wpsp-action-col">
										...
										<!-- <a href="javascript:;" sid="<?php echo intval($wpsp_subject->id);?>" class="SubjectDeleteBt" title="Delete"><i class="icon wpsp-trash wpsp-delete-icon" data-id="14"></i></a> -->
									</div>	
								</td>
							<?php } ?> 
							</tr>
								...
								<div class="tabbable-line">
									<div class="tabSec wpsp-nav-tabs-custom" id="verticalTab"> 
										...
										<?php $i=0; foreach($child as $ch) { ?>
											<li class="wpsp-tabing <?php echo ($i==0)?'active':''?>"><!-- <a href="#<?php echo str_replace(" ", "",$ch['fname'].$i);?>"  data-toggle="tab"> --><?php echo $ch['name'];?><!-- </a> --></li>
											<?php $i++; } ?>
										</ul>
										</div>
