    ...
    var q = function(l) {
        ...
        b.extend(d.prototype, {
            ...
            init: function() {
                ...
                this.styles = "object" === typeof this.options.styling ? this.options.styling : d.styling["bootstrap3"];
                this.elem = b("<div />", {
                    "class": "ui-pnotify wpsp-notification-popup" + this.options.addclass,
                    css: {
                        display: "none"
                    },
                    "aria-live": "assertive",
        ...
        b.extend(d.styling.fontawesome, {
            notice_icon: "fa fa-question-circle-o",
