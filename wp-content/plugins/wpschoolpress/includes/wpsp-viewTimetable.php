                ...
                <div class="wpsp-row">
                    ...
                    <table class="wpsp-table wpsp-table-bordered"  id="timetable_table" cellspacing="0" width="100%" style="width:100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr id="<?php echo $j; ?>">
                                    <td> <!-- <span class="dayval">Day <?php echo $j; ?></span> --><span class="daynam"><?php echo $week_days[$j];?></span></td>
                                    <?php
                                     $subida = array(); 
...
$pa = 0;
                                        foreach ($session as $ses) {
                                            ...
                                            ?>
                                            <td tid="<?php echo $subida[$pa]; ?>" data-sessionid="<?php echo $key; ?>"> <?php echo $sub_name; ?> </td>
