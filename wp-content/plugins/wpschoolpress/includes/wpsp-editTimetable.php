...
<section class="content">
		...
		<div class="wpsp-col-md-12">
			<div class="wpsp-card">
				...
				<div class="wpsp-card-body">
					...
					if( count($clt) == 0 ) {
						$error = 1;
						echo "<div class='wpsp-text-red'>No Subjects retrieved, Check you have subject for this class at <a href='".site_url()."/sch-subject'>Subjects</a></div>";
					}
					if( $error == 0 ) {
						$timetable	=	array();
					...
					echo '<div class="removesubject">
						<div class="item" id="' . $id->id . '" style="width:auto; color:#5cb85c;">' . $id->sub_name . '
						</div>	
					</div>';
					}
					?>
 ...
 $sub_name_f = $wpdb->get_results("SELECT sub_name from $subject_table where id=$subida[$pa]");
                                             //  print_r($sub_name_f);
                                                $sub_name = isset( $sub_name_f[0]->sub_name ) ? $sub_name_f[0]
                                                ->sub_name : 'N/A';
													}
												if( !empty( $sub_name ) ) {
